...
cfg = Cfg({
    "name" : "yun",      # Unique name for this specific configuration
    "key_name": "yun_dist",          # Necessary to ssh into created instances
    ...
    "path_to_keyfile" : "/home/ubuntu/key/yun_dist.pem",

    # NFS configuration
    # To set up these values, go to Services > ElasticFileSystem > Create new filesystem, and follow the directions.
    "nfs_ip_address" : "172.31.3.7",         # us-west-2c
    #"nfs_ip_address" : "172.31.35.0",          # us-west-2a
    #"nfs_ip_address" : "172.31.28.54",          # us-west-2b
    "nfs_mount_point" : "/efs",       # NFS base dir
...
#        run_command(make_outdir_argv, quiet=True)
    ...
    def setup_nfs():
        ...
        create_mount_command = "sudo mkdir %s" % configuration["nfs_mount_point"]
